...
import { Trash2, Calendar, Phone, MapPin, FileText, Lock, ArrowLeft, MessageCircle } from 'lucide-react';
                        ...
                        <div>
                          ...
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button variant="outline" size="sm" className="font-semibold text-sm sm:text-base">
