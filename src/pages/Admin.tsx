                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mb-3 sm:mb-4">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            <a
                              href={`tel:${schedule.khatib?.noHP}`}
                              className="text-primary hover:underline font-semibold text-sm sm:text-base flex items-center gap-1"
                            >
                              <Phone className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                              {schedule.khatib?.noHP}
                            </a>
                            <a
                              href={`https://wa.me/${schedule.khatib?.noHP?.replace(/^0/, '62').replace(/\D/g, '')}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="px-2 py-1 bg-green-500 hover:bg-green-600 text-white text-xs rounded-md transition-colors flex items-center gap-1"
                            >
